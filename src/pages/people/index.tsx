...
import { PeopleInterface, ColumnsType } from "../../types";
...
const People = (): JSX.Element => {
  const { data, error, loading } =
    useFetchAll<PeopleInterface>(peopleRepository);
  const router = useRouter();

  const columns: Array<ColumnsType<PeopleInterface>> = [
    {
      header: "#",
  ...
  const handleClick = (item: PeopleInterface) => {
