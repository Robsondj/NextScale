...
import { ScaleType, UseFetchScalesType } from "../../types/types";
  ...
  return (
    <div className="md:grid md:grid-cols-2 md:gap-2">
      <div className="rounded-lg border-4 border-solid border-gray-200">
        ...
        {Object.keys(error).length > 0 && <div>Something went wrong</div>}
        {scales &&
          scales.map((item, index) => (
            ...
            >
              ...
              <div className="flex">
                ...
                Função: {item.people[0].role.name}
              </div>
              <div className="flex">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      {scales && <DashboardDetail scale={scaleDetail || scales[0]} />}
    </div>
  );
};
